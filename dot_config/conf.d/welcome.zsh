...
# Формуємо рядок дати (Українська локаль зазвичай виводить назви місяців і днів правильно)
# %A - повна назва дня тижня, %d - день, %B - назва місяця, %Y - рік, %H:%M - час
...
# --- Виведення ---
echo "\033[1;33m$GREETING, Романе!\033[0m"
echo "\033[36mДата: $FULL_DATE\033[0m"
...
# Пам'ять (Disk) - виправлено вирівнювання
